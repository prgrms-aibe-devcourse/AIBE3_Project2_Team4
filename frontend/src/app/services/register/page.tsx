...
export default function ServiceRegisterPage() {
  ...
  const handleSubmit = () => {
    if (!selectedCategory || selectedTags.length === 0 || !serviceName || !serviceDescription || !price) {
  ...
  const availableTags = selectedCategory ? tagsByCategory[selectedCategory as keyof typeof tagsByCategory] || [] : []
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{isEditMode ? "서비스 수정" : "새 서비스 등록"}</h1>
          ...
          <CardContent className="p-8">
            <div className="space-y-8">
                  ...
                  {selectedCategory && (
                    <div className="space-y-3">
                      <Label className="text-sm font-medium text-gray-700">
                        ...
                        <span className="text-gray-500 text-xs ml-2">(여러 개 선택 가능)</span>
                      </Label>
                  ...
                  <div className="space-y-3 p-4 bg-blue-50 rounded-lg">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {selectedTags.map((tag) => (
                        <Badge key={tag} className="bg-blue-600 text-white hover:bg-blue-700 pr-1">
                          {tag}
                          <button
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-400 transition-colors">
                    ...
                    <label htmlFor="image-upload" className="cursor-pointer">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-gray-600 mb-1">클릭하여 이미지를 선택하거나 드래그하여 업로드하세요</p>
                        <p className="text-sm text-gray-500">최대 10장까지 업로드 가능 (JPG, PNG, GIF)</p>
                      </div>
                    </label>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 p-3 bg-amber-50 rounded-lg">
                        ...
                        <p className="text-sm text-amber-800">
                          <strong>대표 이미지:</strong> 이미지를 클릭하여 대표 이미지로 설정할 수 있습니다. 대표
                          이미지는 서비스 목록에서 먼저 표시됩니다.
                        </p>
                      </div>
                            ...
                            >
                              ...
                              {index !== mainImageIndex && (
                                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 rounded-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all">
                                  <div className="bg-white text-gray-900 text-xs px-2 py-1 rounded shadow-sm">
                                    클릭하여 대표 이미지로 설정
                                  </div>
                                </div>
                              )}
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-4 pt-6">
                ...
                <Button size="lg" onClick={handleSubmit} className="bg-blue-600 hover:bg-blue-700 text-white h-12 px-8">
