        ...
        <div className="w-full max-w-md">
          <Card className="border-border/50 shadow-lg">
            <CardHeader className="text-center">
              ...
              <CardDescription>입력하신 이메일로 비밀번호 재설정 링크를 발송했습니다.</CardDescription>
            </CardHeader>
        ...
        <Card className="border-border/50 shadow-lg">
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center text-sm text-muted-foreground">
              아이디를 잊으셨나요?{" "}
              <Link href="/auth/find-id" className="text-primary hover:text-primary/80 transition-colors font-medium">
                아이디 찾기
              </Link>
            </div>
          </CardContent>
